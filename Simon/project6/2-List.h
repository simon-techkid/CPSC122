...
public:
    ...
    /*
    pre: None. This is the constructor function, invoked like this from the the client program: 
    List lst;
	or
	List* lst1 = new List;
    ...
    */ 
    ...
    /*
    Desc: A list is passed in by reference. The list being is a copy of that reference list
    ...
    */
    ...
    This is the destructor function, automatically invoked in the case of a static declaration,
        explcitly invoked, using the delete
