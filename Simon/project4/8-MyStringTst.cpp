...
int main(int argc, char* argv[]) {
    ...
    cout << "myStrcpy Initial Value (\"" << argument << "\"): ";
    str2->myDisplay();
    char testStr1[6] = "Hello";
    str2->myStrcpy(testStr1);
    cout << "myStrcpy Run (\"Hello\"): ";
    str2->myDisplay();
    char testStr2[8] = "Goodbye";
    cout << "myStrcpy Run (\"Goodbye\"): ";
    ...
    cout << "isEqual Run: " << ((isEqTest1 && isEqTest2) ? "yes" : "no") << endl;
    cout << endl;
    //End Test of myStrcpy
    ...
    cout << "find Run: " << (allPass ? "yes" : "no") << endl;
    cout << endl;
    //End Test of myStrcpy
